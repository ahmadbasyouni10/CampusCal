...
function App() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log({ classes, isAthlete, athleteHours, sleepHours });
    };
    ...
    return (
        <div className="App">
            ...
            <div className="test">
                ...
                <input type="number" value={numClasses} onChange={handleNumClassesChange} min="1" max="10" />
                <button onClick={() => setClasses(Array(numClasses).fill({ className: '', room: '', startTimeHour: '1', startTimeMinute: '00', startTimeAmPm: 'AM', endTimeHour: '1', endTimeMinute: '00', endTimeAmPm: 'AM' }))}>Get Started</button>
            </div>
            <form onSubmit={handleSubmit}>
                {classes.map((cls, index) => (
                    <div key={index} className="input-group">
                        ...
                        <p>Start Time:
                            <select value={cls.startTimeHour} onChange={e => handleClassChange(index, 'startTimeHour', e.target.value)}>
                        ...
                        <p>End Time:
                            <select value={cls.endTimeHour} onChange={e => handleClassChange(index, 'endTimeHour', e.target.value)}>
                                {generateTimeOptions(12)}
                            </select> :
